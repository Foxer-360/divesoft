...
function ServicePointsMap(props) {
    var _a = props.data, title = _a.title, filterByAddress = _a.filterByAddress, additionalFilterText = _a.additionalFilterText, mapItems = _a.mapItems;
    return (React.createElement(List_1.default, { data: mapItems }, function (_a) {
        ...
        return (React.createElement("div", { className: 'servicePointsMapWrapper' },
            ...
            React.createElement(Map_1.default, { mapItems: data, filterByAddress: filterByAddress, additionalFilterText: additionalFilterText, type: 'service' })));
    }));
}
