        ...
        return (React.createElement("div", { className: 'mapRow' },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "row mapRow__list" },
                    ...
                    React.createElement("div", { className: "col-12 col-md-9" }, data && data.map(function (item, i) { return (React.createElement(MapRow_1.default, { key: i, city: item.city, web: item.web, text: item.text, title: item.title, phone: item.phone, email: item.email, address: item.address, storeChief: item.storeChief })); }))))));
    }));
};
