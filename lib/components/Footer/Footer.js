...
function (_super) {
  ...
  Footer.prototype.render = function () {
    ...
    return React.createElement(ComposedQuery, null, function (_a) {
      ...
      return React.createElement("div", null, React.createElement("div", {
      ...
      }, React.createElement("nav", null, React.createElement("ul", null, firstBottomNavItems && firstBottomNavItems.map(function (navItem, i) {
        return React.createElement("li", {
          key: i
        }, React.createElement(_Link.default, {
          url: navItem.url && navItem.url
        }, navItem.name || navItem.title));
      }))), React.createElement("nav", null, React.createElement("ul", null, secondBottomNavItems && secondBottomNavItems.map(function (navItem, i) {
        return React.createElement("li", {
          key: i
        }, React.createElement(_Link.default, {
          url: navItem.url && navItem.url
        }, navItem.name || navItem.title));
      }))), React.createElement("nav", null, React.createElement("ul", null, thirdBottomNavItems && thirdBottomNavItems.map(function (navItem, i) {
        return React.createElement("li", {
          key: i
        }, React.createElement(_Link.default, {
          url: navItem.url && navItem.url
        ...
        className: 'footer__navigation__contacts'
      }, React.createElement("h6", null, "Kontakt"), React.createElement("p", null, "Divesoft, s.r.o.", React.createElement("br", null), "H\xE1lkova 2495", React.createElement("br", null), "413 01 Roudnice nad Labem", React.createElement("br", null), React.createElement("br", null), "\u010Cesk\xE1 republika", React.createElement("br", null), "Tel.: +420 416 857 057", React.createElement("br", null), "E-mail: info@divesoft.cz"))), React.createElement("div", {
        className: 'footer__bottom'
      }, React.createElement("div", {
        className: 'footer__bottom__social'
      }, "social1"), React.createElement("p", null, "Copyright \xA9 2019 Divesoft LLC All rights reserved.")))));
    });
  };
