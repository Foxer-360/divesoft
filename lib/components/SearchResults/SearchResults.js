...
var SearchResults = function SearchResults(props) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement("div", {
      className: 'searchResults__holder'
    }, React.createElement("h2", {
      className: "searchResults__holder__heading"
    }, "Search Results:"), React.createElement("div", {
      className: 'searchResults__closeIcon',
      onClick: function onClick() {
        return handleSearch('');
      }
    }, "X"), React.createElement("ul", null, filteredPages && filteredPages.length > 0 && filteredPages.map(function (page, index) {
