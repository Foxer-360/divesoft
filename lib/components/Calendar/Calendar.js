...
function (_super) {
  ...
  function Calendar(props) {
    ...
    _this.search = function () {
      var _a = _this.state,
          ...
          dateSelectedValue = _a.dateSelectedValue;
  ...
  Calendar.prototype.renderDays = function () {
    ...
    var startDate = _dateFns.default.startOfWeek(this.state.currentMonth); // const Mobile = props => <Responsive {...props} maxWidth={767} />;
  ...
  Calendar.prototype.renderControls = function () {
    ...
    return _react.default.createElement("div", {
      ...
      onChange: function onChange(e) {
        return _this.onSelectChange(e, 'date');
      },
      value: this.state.dateSelectedValue
    }, uniqDates && uniqDates.map(function (item, i) {
    ...
    }, keywords && keywords.map(function (item, i) {
      return _react.default.createElement("option", {
        key: i,
        value: item
      }, item);
